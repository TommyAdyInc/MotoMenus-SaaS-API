...
class PdfTest extends TestCase
{
     ...
     * @return void
     */
    public function creates_a_finance_insurance_pdf_successfully()
    {
        Passport::actingAs($this->user);
        ...
        $this->json('POST', '/api/deal', [
            ...
            'finance_insurance' => [
                'cash_down_payment' => 2000,
                'preferred_standard_rate' => 13.49,
                'preferred_standard_term' => 24,
                'promotional_rate' => 12,
                'promotional_term' => 24,
                'full_protection' => 100,
                'limited_protection' => 100,
                'tire_wheel' => 100,
                'gap_coverage' => 100,
                'theft' => 100,
                'priority_maintenance' => 100,
                'appearance_protection' => 100,
            ]
        ])
            ->assertStatus(201);

        $response = $this->json('GET', '/api/pdf/1', ['type' => 'finance', 'unit' => '', 'trade' => '']);
        $response
            // ->dump()
            ->assertStatus(201);
